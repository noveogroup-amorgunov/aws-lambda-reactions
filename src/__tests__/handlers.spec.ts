...
describe('getReactions', () => {
  it('should respond reactions by post slug', async () => {
    const dynamoSpy = jest.spyOn(Dynamo, 'get').mockImplementation(async () => defaultRecord);
  ...
  it('should respond reactions anyway even if post is not exist', async () => {
    const dynamoSpy = jest.spyOn(Dynamo, 'get').mockImplementation(async () => null);
...
describe('setReaction', () => {
  it('should set reaction and respond actual reactions', async () => {
    const dynamoGetSpy = jest.spyOn(Dynamo, 'get').mockImplementation(async () => defaultRecord);
    const dynamoUpdateSpy = jest.spyOn(Dynamo, 'update').mockImplementation(async () => null);
  ...
  it('should set first reaction, create post and respond actual reactions', async () => {
    const dynamoGetSpy = jest.spyOn(Dynamo, 'get').mockImplementation(async () => null);
    const dynamoUpdateSpy = jest.spyOn(Dynamo, 'put').mockImplementation(async () => null);
